    ...
    this.setState(
      ...
      function () {
        if (
          ...
          this.state.activeRoute === 'polls' ||
          this.state.activeRoute === 'all'
        ) {
          this.fetchPolls();
        }
      }
    ...
    return (
      <div>
        ...
        {this.state.loading ? (
          ...
          <div>
            {['polls', 'poll', 'all', '/'].indexOf(this.state.activeRoute) >
              -1 && (
              <Content
                loggedIn={this.state.loggedIn}
                activeRoute={this.state.activeRoute}

...
module.exports = function (app, passport) {
  ...
  app.route('/checklogin').get(function (req, res) {
  ...
  app.route('/api/addpoll').post(isLoggedIn, pollHandler.addPoll);

  app.route('/api/vote').post(pollHandler.vote);
  //////////////
  ...
  app
    ...
    .post(function (req, res) {
      console.log(
        'The user is ' + req.isAuthenticated() ? '' : 'not' + ' authenticated'
      );
